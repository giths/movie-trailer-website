...
# bootstrap url prefix
bstrap_url_pre = "https://netdna.bootstrapcdn.com/bootstrap/3.1.0"
...
''' + '''
    ...
    <!-- Bootstrap 3 -->
    <link rel="stylesheet" href="{bstrap_url_pre}/css/bootstrap.min.css">
    <link rel="stylesheet" href="{bstrap_url_pre}/css/bootstrap-theme.min.css">
    <script src="http://code.jquery.com/jquery-1.10.1.min.js"></script>
    <script src="{bstrap_url_pre}/js/bootstrap.min.js"></script>

'''.format(bstrap_url_pre=bstrap_url_pre) + '''
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        $(document).on(
            ...
            function (event) {
                ...
                // this is the only reliable way to ensure the video
                // stops playing in IE
...
<div class="col-md-6 col-lg-4 movie-tile text-center"
 ...
 data-toggle="modal" data-target="#trailer">
    ...
    <span class="overlay"> <h2> Director <h3>{movie_director}</h3></h2></span>
    <h2>{movie_title}</h2>
    <h3>Rating {movie_rating}</h2>
</div>
'''
